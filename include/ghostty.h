...
GHOSTTY_API void ghostty_surface_input_text(ghostty_surface_t, const char*, uintptr_t);
...
GHOSTTY_API bool ghostty_surface_accessibility_command_output(ghostty_surface_t,
                                                              ghostty_text_s*);
